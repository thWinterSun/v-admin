<template lang="html">
    <div>
        <Row class="ph_10">
            ...
            <Col span="1" >
                <Button type="primary" class="ivu-btn-cir btn-p" title="全部删除">
                    <Icon type="trash-a"></Icon>
                </Button>
            </Col>
            <Col span="5" offset="15" >
                <Input icon="ios-search" placeholder="搜索."></Input>
            </Col>
        </Row>
        <Row>
            <Col span="24">
...
export default {
    ...
    computed: mapState([
        "get_role_list" // 从仓库store.js 中获取请求
    ]),
    methods: {
        fetchData () {
            this.error = null;
            this.loading = true;
            this.getTableData(this.get_role_list);
        },
        ...
        addForm () {
            this.$router.replace({ path: '/table/role/add' })
        },
        setPage (page) {
